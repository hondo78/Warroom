...
window.I18N.en.agentWorkflow = {
    ...
    burstHint: "Safety net: alert via Telegram/Teams when the agent <strong>auto-blocks</strong> more IPs than the threshold within the window — an early warning that a misfiring rule or learned pattern is flooding the blocklist. Throttled to one alert per window.",
    burstEnabled: "Burst alarm active",
    burstThreshold: "Blocks per window",
    burstWindow: "Window (minutes)",
    ...
    stages: {
        ...
        anomaly: { label: "FW anomalies", trigger: "Isolation Forest anomalies over NetFlow (volume/ports/night) → OSINT triage; non-malicious anomalies are marked 'Suspicious'" },
    ...
    fields: {
        ...
        agent_anomaly_interval_seconds: "Interval (s)",
        agent_anomaly_hours: "NetFlow window (h)",
