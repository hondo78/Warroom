...
window.I18N.de.fwAnomalies = {
    ...
    conn2_assess: "KI-Bewertung",
    conn2_assess_title: "KI-Agent bewertet jetzt jede Verbindung (Quelle + Ziel per OSINT) und zieht Rückschlüsse, was sie ist",
    conn2_assess_confirm: "Der KI-Agent bewertet jetzt jede auffällige Verbindung: er reichert Quelle (interner Hostname) und Ziel (OSINT/FQDN/ASN) an, schlussfolgert was die Verbindung ist (z. B. HomeAssistant → Wetter-Server) und setzt eine begründete Bewertung. Fortfahren?",
    conn2_assess_running: "KI bewertet…",
    conn2_assess_failed: "KI-Bewertung fehlgeschlagen",
