...
window.I18N.de.fwAnomalies = {
    ...
    conn2_title: "Verbindungs-Anomalien",
    conn2_sub: "— C2-Beaconing & untypische Uploads (pro Verbindung)",
    conn2_kind_all: "Alle Typen",
    conn2_kind_c2: "C2-Beaconing",
    conn2_kind_exfil: "Untypischer Upload",
    conn2_kind_new: "Neu / untypisch",
    conn2_minscore_title: "Nur Verbindungen ab diesem Score anzeigen",
    conn2_scan: "Agent-Scan (Alarm)",
    conn2_scan_title: "Agent bewertet C2/Exfil jetzt und schlägt Alarm (Telegram/Teams)",
    conn2_scan_confirm: "Der Agent bewertet jetzt alle C2/Exfil-Verbindungen über der Alarm-Schwelle und sendet echte Telegram/Teams-Alarme. Fortfahren?",
    conn2_scan_failed: "Agent-Scan fehlgeschlagen",
    conn2_hint: "Bewertet werden <strong>einzelne Verbindungen (eine interne IP → eine externe IP)</strong> gegen eine 30-Tage-Baseline derselben Paare. Erkannt werden <strong>C2-Beaconing</strong> (regelmäßige kleine Verbindungen zu einem seltenen/neuen Ziel) und <strong>untypische Uploads / Exfiltration</strong> (großes, upload-lastiges Volumen zu einem neuen/seltenen Ziel). Normal = das Paar wiederholt sich an vielen Tagen bzw. das Ziel wird von vielen internen Hosts kontaktiert (geteilter Dienst).",
    conn2_filter_ph: "Filter (IP, Typ, Signal…)",
    conn2_meta: "· {c} Verbindungen geprüft · {b} Baseline-Paare",
    conn2_none: "Keine auffälligen Verbindungen im Zeitfenster.",
    conn2_col_type: "Typ",
    conn2_col_src: "Quelle (intern)",
    conn2_col_dst: "Ziel (extern)",
    conn2_col_volume: "Volumen ↑/↓",
    conn2_col_signals: "Signale",
    conn2_vol_title: "↑ ausgehend (Upload) · ↓ eingehend (Download)",
    // signal chips
    sig_new: "neues Paar",
    sig_uncommon: "selten ({d} T)",
    sig_rare: "Einzelziel",
    sig_shared: "geteilt ({n} Hosts)",
    sig_upload: "Upload {b} ({p}%)",
    sig_beacon: "Beacon ~{s}s · {n}×",
    sig_beacon_title: "Regularität {r} · über {m} min · {bpf} B/Flow",
    sig_offhours: "nachtaktiv {p}%",
};
