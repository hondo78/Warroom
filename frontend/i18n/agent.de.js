...
window.I18N.de.agent = {
    ...
    // Qualität & Feedback
    quality_title: "Qualität & Feedback",
    quality_hint: "Eine „zurückgenommene\" Entscheidung wurde ausgeführt und danach von einem Menschen widerrufen — also ein bestätigter False Positive. FP-Rate = zurückgenommen / (aktiv + zurückgenommen).",
    qual_fp_rate: "False-Positive-Rate",
    qual_auto_fp: "Auto-Approval FP-Rate",
    qual_acted: "Blocks (aktiv + zurückgenommen)",
    qual_window: "im Zeitfenster",
    qual_patterns: "Aktive Auto-Muster",
    qual_of_total: "von {n} Mustern",
    qual_by_source: "Pro Quelle",
    qual_col_source: "Quelle",
    qual_col_executed: "Aktiv",
    qual_col_declined: "Zurückgenommen",
    qual_col_failed: "Fehler",
    qual_col_fp: "FP-Rate",
    qual_top_patterns: "Top gelernte Muster",
    qual_col_rule: "Signatur",
    qual_col_approvals: "Freigaben",
    qual_col_rejections: "Ablehnungen",
    qual_col_net: "Netto",
    qual_col_auto: "Auto",
    qual_none: "Keine Daten im Zeitfenster.",
};
