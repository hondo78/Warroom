...
window.I18N.de.blocked = {
    ...
    // block provenance (who + which detection)
    by_agent: "Vom KI-Agent geblockt",
    by_human: "Manuell durch einen Menschen geblockt",
    who_ai: "KI",
    who_human: "Mensch",
    src_manual: "Manuell",
    src_bulk: "Manuell (Bulk)",
    src_chat: "Chat",
    src_anomaly: "Anomalie",
    src_connection: "Verbindung",
    src_waf: "WAF",
    src_ips: "IPS",
    src_failed_login: "Login-Brute-Force",
    src_event: "Event",
    src_triage: "Triage",
    src_alert: "Alarm",
    src_agent: "Agent",
