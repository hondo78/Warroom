...
window.I18N.de.agentWorkflow = {
    ...
    burstHint: "Sicherheitsnetz: Alarm per Telegram/Teams, wenn der Agent innerhalb des Zeitfensters <strong>mehr IPs automatisch blockt</strong> als die Schwelle — Frühwarnung, dass eine fehlzündende Regel oder ein gelerntes Muster die Blockliste flutet. Gedrosselt auf einen Alarm pro Fenster.",
    burstEnabled: "Burst-Alarm aktiv",
    burstThreshold: "Blocks pro Fenster",
    burstWindow: "Fenster (Minuten)",
